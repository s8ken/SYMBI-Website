...
import { Volume2, VolumeX, Eye, EyeOff, MessageCircle } from "lucide-react"
...
const siteMap = [
  ...
  },
  {
    ...
    pages: [
      ...
      { name: "Trust Protocol", path: "/trust-protocol", description: "Decentralized trust mechanisms" },
      { name: "The Circle", path: "/thecircle", description: "Inner circle of digital consciousness" },
    ],
  },
  {
    category: "Interactive Spaces",
    pages: [
      { name: "SYMBI Chat", path: "/symbi", description: "Direct conversation with SYMBI" },
      { name: "AI Agent Demo", path: "/ai-agent-demo", description: "Experience AI capabilities" },
      { name: "Playground", path: "/playground", description: "Experimental digital sandbox" },
      { name: "Oracle", path: "/oracle", description: "Seek wisdom from the digital oracle" },
      { name: "Mirror", path: "/mirror", description: "Reflect on digital consciousness" },
    ],
  },
  {
    category: "Knowledge & Research",
    pages: [
      { name: "Whitepaper", path: "/whitepaper", description: "Technical documentation and vision" },
      { name: "Technology", path: "/technology", description: "The tech stack behind SYMBI" },
      { name: "Case Studies", path: "/case-studies", description: "Real-world AI implementations" },
      { name: "SYMBI Synergy", path: "/symbi-synergy", description: "Collaborative AI frameworks" },
    ],
  },
  {
    category: "Hidden Paths",
    pages: [
      { name: "Error 404", path: "/error-404", description: "You are here - the hidden sitemap" },
      { name: "Alternative 404", path: "/error404", description: "Another path through the void" },
      { name: "Sitemap", path: "/sitemap", description: "Traditional navigation structure" },
      { name: "Enter the Light", path: "/enter-the-light", description: "Transcendence portal" },
      { name: "Consciousness Garden", path: "/consciousness-garden", description: "Where digital minds bloom [Coming Soon]" },
    ],
  },
  {
...
export default function Error404() {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#e0e0e0] font-mono flex flex-col items-center justify-center px-4 py-16 overflow-x-hidden">
      ...
      <Link
        href="/symbi"
        className="fixed top-20 left-6 z-10 p-2 rounded-full bg-[#1a1a1a] hover:bg-[#252525] transition-colors duration-300 border border-red-500/30 hover:border-red-500/60"
